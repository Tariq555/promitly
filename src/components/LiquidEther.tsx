...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class CommonClass {
      width=0; height=0; aspect=1; pixelRatio=1; fboWidth:any=null; fboHeight:any=null;
      time=0; delta=0; container:any=null; renderer:any=null; clock:any=null;
      init(container: any) {
    ...
    class MouseClass {
      ...
      diff=new THREE.Vector2(); timer:any=null; container:any=null; docTarget:any=null;
      listenerTarget:any=null; isHoverInside=false; hasUserControl=false; isAutoActive=false;
      autoIntensity=2.0; takeoverActive=false; takeoverStartTime=0; takeoverDuration=0.25;
      takeoverFrom=new THREE.Vector2(); takeoverTo=new THREE.Vector2(); onInteract:any=null;
    ...
    class AutoDriver {
      mouse:any; manager:any; enabled:boolean; speed:number; resumeDelay:number; rampDurationMs:number;
      ...
      update() {
        ...
        let dt2=(now-this.lastTime)/1000; this.lastTime=now; if (dt2>0.2) dt2=0.016;
        ...
        this.current.addScaledVector(dir,Math.min(this.speed*dt2*ramp,dist));
    ...
    class Viscous extends ShaderPass {
      ...
      update({viscous,iterations,dt}: any) {
        this.uniforms.v.value=viscous; let fo,fi;
  ...
  useEffect(() => {
    ...
    const prev = sim.options.resolution;
